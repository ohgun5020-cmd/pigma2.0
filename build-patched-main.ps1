...
$bundle = Replace-Exact `
  ...
  -Replace 'function pigmaDashPattern(e){if(!e||!Array.isArray(e.dashPattern))return null;let t=e.dashPattern.map(r=>Number(r)).filter(r=>Number.isFinite(r)&&r>0);return t.length>0?t:null}function Di(e){if(te(e))return null;let t="fills"in e&&Array.isArray(e.fills)?wi(e.fills):null,r="strokes"in e&&Array.isArray(e.strokes)?Gr(e.strokes):null,o=null;if(r){let n=Jr(e);if(n===null)return null;o={kind:"solid",color:Ge(r),width:n,position:Or(e),dashPattern:pigmaDashPattern(e)}}return!t&&!o?null:{fill:t,stroke:o}}' `
  -ExpectedCount 1 `
...
$editableTextParagraphRunsHelper = 'function editableTextParagraphStyle(e,t){let n={justification:e,autoHyphenate:!1};return pigmaEditableTextUsesPhotoshopCjkMetrics(t)&&(n.autoLeading=pigmaEditableTextAutoLeading(t),n.leadingType=1),n}function editableTextEngineText(e){return(e||"").replace(/\r\n?|\n/g,"\r")}function editableTextParagraphRuns(e,t,n){let r=editableTextEngineText(e).split("\r"),o=[];for(let i=0;i<r.length;i++){let a=r[i],s=a.length+(i<r.length-1?1:0);s>0&&o.push({length:s,style:editableTextParagraphStyle(t,n)})}return o}'
...
$editableTextVerticalAlignHelper = 'function pigmaEditableTextVerticalJustification(e){switch(e){case"CENTER":return"center";case"BOTTOM":return"bottom";default:return"top"}}function pigmaEditableTextLineCount(e){return Math.max(1,editableTextEngineText(e||"").split("\r").length)}function pigmaEditableTextUsesPhotoshopCjkMetrics(e){return!!(e&&typeof pigmaEditableTextFontScript=="function"&&pigmaEditableTextFontScript(e)===4)}function pigmaEditableTextAutoLeading(e){return pigmaEditableTextUsesPhotoshopCjkMetrics(e)?1.75:1.2}function pigmaEditableTextUsesPhotoshopAutoLeading(e){return pigmaEditableTextUsesPhotoshopCjkMetrics(e)&&!Number.isFinite(Number(e&&e.lineHeightPx))}function pigmaEditableTextAutoLeadingPx(e){let t=Number(e&&e.fontSize),n=Number.isFinite(t)&&t>0?t:12;return Math.max(1,n*pigmaEditableTextAutoLeading(e))}function pigmaEditableTextResolvedLineHeight(e){let t=e&&e.text&&e.text.baseStyle?e.text.baseStyle:{},n=Number(t.lineHeightPx);return Number.isFinite(n)&&n>0?n:pigmaEditableTextAutoLeadingPx(t)}function pigmaEditableTextBoxVerticalOffset(e,t){if(!e||!e.text||e.text.shapeType!=="box"||!t)return 0;let n=e.text.verticalJustification;if(n!=="center"&&n!=="bottom")return 0;let r=Math.max(0,Number(t[3])-Number(t[1])),i=pigmaEditableTextResolvedLineHeight(e)*pigmaEditableTextLineCount(e.text.value),a=Math.max(0,r-i);return we(n==="bottom"?a:a/2)}function pigmaOffsetEditableTextTransform(e,t){return Math.abs(t)>=.01?[e[0],e[1],e[2],e[3],we(e[4]),we(e[5]+t)]:e}'
$editableTextEngineMetadataReplacement = $editableTextParagraphRunsHelper + $editableTextEngineDataHelper + $editableTextIndexHelper + $editableTextVerticalAlignHelper + 'function g1(e){let t=E1(e),n=w1(e,t),r=ym(e),i=yh(e.text.bounds,r),a=yh(e.text.boundingBox,r),o=e.text.boxBounds?e.text.boxBounds.map(f=>we(f)):null,s=v1(e,n,i,a,o),c=editableTextEngineText(e.text.value),l=editableTextParagraphRuns(c,e.text.justification,e.text.baseStyle),u={text:c,transform:pigmaOffsetEditableTextTransform(n,pigmaEditableTextBoxVerticalOffset(e,o)),antiAlias:"smooth",orientation:"horizontal",gridding:"none",useFractionalGlyphWidths:!0,left:s.layerBounds.left,top:s.layerBounds.top,right:s.layerBounds.right,bottom:s.layerBounds.bottom,bounds:{left:{value:s.textBounds.left,units:"Pixels"},top:{value:s.textBounds.top,units:"Pixels"},right:{value:s.textBounds.right,units:"Pixels"},bottom:{value:s.textBounds.bottom,units:"Pixels"}},boundingBox:{left:{value:s.boundingBox.left,units:"Pixels"},top:{value:s.boundingBox.top,units:"Pixels"},right:{value:s.boundingBox.right,units:"Pixels"},bottom:{value:s.boundingBox.bottom,units:"Pixels"}},paragraphStyle:editableTextParagraphStyle(e.text.justification,e.text.baseStyle),paragraphStyleRuns:l,style:kh(e.text.baseStyle,t.boxBaselineShift),styleRuns:e.text.styleRuns.map(c=>({length:c.length,style:kh(c.style,t.boxBaselineShift)}))};return u.shapeType=e.text.shapeType,e.text.pointBase&&(u.pointBase=e.text.pointBase.slice()),o&&(u.boxBounds=o),u}'
...
$editableBoxTextPreviewBoundsReplace = 'async function zn(e,t,r){var a,s;let o=Ae(e,t.shapeType);if(!o)return null;let n=((a=r==null?void 0:r.riskScore)!=null?a:0)>=No?Wr(t,(s=r==null?void 0:r.riskScore)!=null?s:0):null;if(t.shapeType!=="point")return{bounds:o,usedVisualProbe:!1};let i=await Li(e,o,r);if(i){let l=Se(it(e,t),n);return{bounds:ie(Vt(o,i),l),usedVisualProbe:!0}}return{bounds:ie(o,Se(it(e,t),n)),usedVisualProbe:!1}}'
...
function pigmaEditableTextUsesVariableNotoKr(e){let t=pigmaNormalizePhotoshopFontToken(e&&e.fontFamily),r=pigmaNormalizePhotoshopFontToken(resolveEditableTextFontName(e));return/^(notosanskr|notoserifkr)/.test(t)||/^(notosanskr|notoserifkr)/.test(r)}
function pigmaEditableTextShouldFauxBold(e){return pigmaEditableTextFontWeight(e)>=600&&(!pigmaEditableTextHasMappedFontFace(e)||pigmaEditableTextUsesVariableNotoKr(e))}
...
function pigmaEditableTextFontScript(e){let t=pigmaNormalizePhotoshopFontToken(e&&e.fontFamily),n=pigmaNormalizePhotoshopFontToken(resolveEditableTextFontName(e));return/^(notosanskr|notoserifkr|notosanscjkkr|notoserifcjkkr|malgungothic|malgun|gulim|gulimche|dotum|dotumche|batang|batangche|gungsuh|gungsuhche)/.test(t)||/^(notosanskr|notoserifkr|notosanscjkkr|notoserifcjkkr|malgungothic|gulim|gulimche|dotum|dotumche|batang|batangche|gungsuh|gungsuhche)/.test(n)?4:0}
function pigmaEditableTextFontType(e){return pigmaEditableTextFontScript(e)===4?1:0}
function editableTextFontDescriptor(e){return{name:resolveEditableTextFontName(e),script:pigmaEditableTextFontScript(e),type:pigmaEditableTextFontType(e),synthetic:0}}
'@
$uiEditableTextFontNameReplace = ($pigmaPhotoshopFontResolver + $uiEditableTextFontNameBody).Replace("`r", "").Replace("`n", "")
$uiEditableTextFontSetOrderFind = ',h=[{name:"AdobeInvisFont",script:0,type:0,synthetic:0}],g=((t=e.style)===null||t===void 0?void 0:t.font)||((r=(n=e.styleRuns)===null||n===void 0?void 0:n.find(function(Z){return Z.style.font}))===null||r===void 0?void 0:r.style.font)||Nf,v=[],m=[],b=e.paragraphStyleRuns;'
$uiEditableTextFontSetOrderReplace = ',g=((t=e.style)===null||t===void 0?void 0:t.font)||((r=(n=e.styleRuns)===null||n===void 0?void 0:n.find(function(Z){return Z.style.font}))===null||r===void 0?void 0:r.style.font)||Nf,h=[g,{name:"AdobeInvisFont",script:0,type:0,synthetic:0}],v=[],m=[],b=e.paragraphStyleRuns;'
...
$uiEditableTextBaselineShiftReplace = 'function pigmaEditableTextLineGapBaselineShift(e){return 0}function pigmaEditableTextResolvedBaselineShift(e,t=0){let n=Number(e&&e.baselineShift);return Number.isFinite(n)?we(n):0}function kh(e,t=0){let n={font:editableTextFontDescriptor(e),fontSize:e.fontSize},r=pigmaEditableTextResolvedBaselineShift(e,t);return pigmaApplyEditableTextFontFaceStyle(e,n),e.fillColor&&(n.fillColor=Uw(e.fillColor)),e.lineHeightPx!==null?(n.leading=e.lineHeightPx,n.autoLeading=!1):pigmaEditableTextUsesPhotoshopAutoLeading(e)?(n.leading=pigmaEditableTextAutoLeadingPx(e),n.autoLeading=!0):n.autoLeading=!0,e.tracking!==0&&(n.tracking=e.tracking,n.autoKerning=!1),e.fontCaps!==0&&(n.fontCaps=e.fontCaps),e.underline&&(n.underline=!0),e.strikethrough&&(n.strikethrough=!0),Math.abs(r)>=.01&&(n.baselineShift=r),n}'
...
function pigmaFindContainerClipBaseIndex(e){return e.findIndex(pigmaIsBaseImageSimulationLayer)}
...
async function pigmaBuildGroupRasterSmartObject(e,t,n,r){let i=e&&e.__pigmaSourceGroup?e.__pigmaSourceGroup:e;if(!i)return null;let a=await pigmaRenderClipBaseSmartObjectCanvas(i,t,n);if(!a)return null;let o=tn(),s=tn(),u=await l1(a.canvas),c=a.bounds.x,f=a.bounds.y,d=a.canvas.width,p=a.canvas.height,h={name:e.name,left:c,top:f,right:c+d,bottom:f+p,opacity:typeof e.opacity=="number"?e.opacity:1,hidden:!!e.hidden,blendMode:wr(e.blendMode||"normal"),canvas:a.canvas,placedLayer:{id:o,placed:s,type:"raster",comp:qi,compInfo:Zo(),transform:[c,f,c+d,f,c+d,f+p,c,f+p],width:d,height:p,resolution:{value:72,units:"Density"}}};return e.effects&&(h.effects=e.effects),e.effectsOpen&&(h.effectsOpen=e.effectsOpen),{layer:h,linkedFiles:[Du(o,"".concat(qo(e.name||"group-smart-object"),".png"),u)],warnings:[r]}}
async function pigmaBuildClipBaseSmartObject(e,t,n){return await pigmaBuildGroupRasterSmartObject(e,t,n,"\"".concat(Su(e&&e.name?e.name:"base image simulation"),"\" was converted to a raster Smart Object so Photoshop clipping masks can target a single pixel layer."))}
async function pigmaBuildClippedGroupSmartObject(e,t,n){return await pigmaBuildGroupRasterSmartObject(e,t,n,"\"".concat(Su(e&&e.name?e.name:"clipped group"),"\" was converted to a raster Smart Object because Photoshop clipping masks do not reliably clip nested layer groups."))}
async function pigmaApplyContainerClipToBackground(e,t=0,n=0){let r={applied:!1,linkedFiles:[],warnings:[]};if(!Array.isArray(e)||e.length<2)return r;let i=pigmaFindContainerClipBaseIndex(e);if(i<0)return r;let a=e[i];if(pigmaIsLayerGroup(a)){let l=await pigmaBuildClipBaseSmartObject(a,t,n);if(!l){r.warnings.push("\"".concat(Su(a&&a.name?a.name:"clip base"),"\" stayed as a group, so Pigma skipped automatic clipping masks for this container to avoid hiding clipped layers in Photoshop."));return r}e[i]=l.layer,r.linkedFiles.push(...l.linkedFiles),r.warnings.push(...l.warnings)}for(let l=i+1;l<e.length;l+=1){let u=e[l];if(u&&typeof u=="object"){if(pigmaIsLayerGroup(u)){let c=await pigmaBuildClippedGroupSmartObject(u,t,n);c?(e[l]=c.layer,u=e[l],r.linkedFiles.push(...c.linkedFiles),r.warnings.push(...c.warnings)):r.warnings.push("\"".concat(Su(u&&u.name?u.name:"clipped group"),"\" stayed as a clipped group because Pigma could not build a Smart Object preview for it."))}u.clipping=!0,r.applied=!0}}return r}
async function vm(
'@
...
} elseif ($uiBundle.Contains('var pigmaPhotoshopFontMap=') -and -not $uiBundle.Contains('function pigmaEditableTextFontScript(')) {
  $uiBundle = Replace-Section `
    -Text $uiBundle `
    -StartMarker 'var pigmaPhotoshopFontMap=' `
    -EndMarker 'function pigmaEditableTextLineGapBaselineShift' `
    -Replacement $uiEditableTextFontNameReplace `
    -Label 'ui editable Korean font descriptor metadata'
} elseif ($uiBundle.Contains('var pigmaPhotoshopFontMap=') -and -not $uiBundle.Contains('function pigmaEditableTextUsesVariableNotoKr(')) {
  $uiBundle = Replace-Section `
    -Text $uiBundle `
    -StartMarker 'var pigmaPhotoshopFontMap=' `
    -EndMarker 'function pigmaEditableTextLineGapBaselineShift' `
    -Replacement $uiEditableTextFontNameReplace `
    -Label 'ui editable Noto KR variable font fallback'
...
if ($uiBundle.Contains($uiEditableTextFontSetOrderFind)) {
  $uiBundle = Replace-Exact `
    -Text $uiBundle `
    -Find $uiEditableTextFontSetOrderFind `
    -Replace $uiEditableTextFontSetOrderReplace `
    -ExpectedCount 1 `
    -Label 'ui editable text primary fontset ordering'
} elseif ($uiBundle.Contains($uiEditableTextFontSetOrderReplace)) {
  # Already patched in this UI bundle variant.
} else {
  throw 'Could not patch UI editable text primary FontSet ordering.'
}
...
if ($uiBundle.Contains($uiEditableTextBaselineShiftFind)) {
  ...
  # Already patched in this UI bundle variant.
} elseif ($uiBundle.Contains('function pigmaEditableTextLineGapBaselineShift(') -and -not $uiBundle.Contains('pigmaEditableTextUsesPhotoshopAutoLeading(e)?(n.leading=pigmaEditableTextAutoLeadingPx(e),n.autoLeading=!0)')) {
  $uiBundle = Replace-Section `
    -Text $uiBundle `
    -StartMarker 'function pigmaEditableTextLineGapBaselineShift' `
    -EndMarker 'function Uw(' `
    -Replacement $uiEditableTextBaselineShiftReplace `
    -Label 'ui editable text Photoshop auto leading'
...
} elseif ($uiBundle.Contains('function pigmaBuildGroupRasterSmartObject(')) {
  # Already patched in this UI bundle variant.
} elseif ($uiBundle.Contains('function pigmaBuildClipBaseSmartObject(')) {
  $helperPattern = '(?s)function Eu\(e\)\{return e\.buffer instanceof ArrayBuffer&&e\.byteOffset===0&&e\.byteLength===e\.buffer\.byteLength\?e\.buffer:e\.buffer\.slice\(e\.byteOffset,e\.byteOffset\+e\.byteLength\)\}.*?async function vm\('
  $helperReplacement = $uiBackgroundClipHelperReplace
  $nextUiBundle = [regex]::Replace($uiBundle, $helperPattern, [System.Text.RegularExpressions.MatchEvaluator]{ param($match) $helperReplacement }, 1)
  if ($nextUiBundle -eq $uiBundle) {
    throw 'Could not refresh UI PSD background clipping smart object helper.'
  }
  $uiBundle = $nextUiBundle
} else {
  throw 'Could not patch UI PSD background clipping helper.'
}

$uiBackgroundClipBackgroundBaseFind = 'function pigmaFindContainerClipBaseIndex(e){let t=e.findIndex(pigmaIsBaseImageSimulationLayer);if(t>=0)return t;let n=e.findIndex(pigmaIsBackgroundClipBaseLayer);return n===0?n:-1}'
$uiBackgroundClipBackgroundBaseReplace = 'function pigmaFindContainerClipBaseIndex(e){return e.findIndex(pigmaIsBaseImageSimulationLayer)}'
if ($uiBundle.Contains($uiBackgroundClipBackgroundBaseFind)) {
  $uiBundle = Replace-Exact `
    -Text $uiBundle `
    -Find $uiBackgroundClipBackgroundBaseFind `
    -Replace $uiBackgroundClipBackgroundBaseReplace `
    -ExpectedCount 1 `
    -Label 'ui PSD background clip avoids background fallback'
} elseif ($uiBundle.Contains($uiBackgroundClipBackgroundBaseReplace)) {
  # Already patched in this UI bundle variant.
} else {
  throw 'Could not patch UI PSD background clip base lookup.'
}
