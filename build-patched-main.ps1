...
$bundle = Replace-Exact `
  ...
  -Replace 'function pigmaShapeFillRequiresSvg(e){return e&&e.kind==="gradient"}function Nr(e){if(re(e)||te(e)||fe(e))return{strategy:"smart-object",fill:null};let t=Ti(e);return t?pigmaShapeFillRequiresSvg(t)?{strategy:"smart-object",fill:t}:{strategy:"shape",fill:t}:{strategy:"smart-object",fill:null}}' `
  -ExpectedCount 1 `
