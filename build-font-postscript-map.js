...
function addCurated(map) {
  const curated = [
    ...
    ["Anonymous Pro", "Bold Italic", "AnonymousPro-BoldItalic"],
    ["Caveat", "Regular", "Caveat-Regular"],
    ["Caveat", "Bold", "Caveat-Bold"],
    ["Crimson Text", "Regular", "CrimsonText-Regular"],
    ["Crimson Text", "Italic", "CrimsonText-Italic"],
    ["Crimson Text", "SemiBold", "CrimsonText-SemiBold"],
    ["Crimson Text", "SemiBold Italic", "CrimsonText-SemiBoldItalic"],
    ["Crimson Text", "Bold", "CrimsonText-Bold"],
    ["Crimson Text", "Bold Italic", "CrimsonText-BoldItalic"],
    ["Figma Hand", "Regular", "FigmaHand-Regular"],
    ["IBM Plex Mono", "Regular", "IBMPlexMono-Regular"],
    ["IBM Plex Mono", "Italic", "IBMPlexMono-Italic"],
    ["IBM Plex Mono", "Medium", "IBMPlexMono-Medium"],
    ["IBM Plex Mono", "Medium Italic", "IBMPlexMono-MediumItalic"],
    ["IBM Plex Mono", "SemiBold", "IBMPlexMono-SemiBold"],
    ["IBM Plex Mono", "SemiBold Italic", "IBMPlexMono-SemiBoldItalic"],
    ["IBM Plex Mono", "Bold", "IBMPlexMono-Bold"],
    ["IBM Plex Mono", "Bold Italic", "IBMPlexMono-BoldItalic"],
    ["Pacifico", "Regular", "Pacifico-Regular"],
    ["Playfair Display", "Regular", "PlayfairDisplay-Regular"],
    ["Playfair Display", "Italic", "PlayfairDisplay-Italic"],
    ["Playfair Display", "Medium", "PlayfairDisplay-Medium"],
    ["Playfair Display", "Medium Italic", "PlayfairDisplay-MediumItalic"],
    ["Playfair Display", "SemiBold", "PlayfairDisplay-SemiBold"],
    ["Playfair Display", "SemiBold Italic", "PlayfairDisplay-SemiBoldItalic"],
    ["Playfair Display", "Bold", "PlayfairDisplay-Bold"],
    ["Playfair Display", "Bold Italic", "PlayfairDisplay-BoldItalic"],
    ["Playfair Display", "Black", "PlayfairDisplay-Black"],
    ["Playfair Display", "Black Italic", "PlayfairDisplay-BlackItalic"],
    ...
    ["Source Serif Pro", "Regular", "SourceSerifPro-Regular"],
    ["Source Serif Pro", "Italic", "SourceSerifPro-It"],
    ["Source Serif Pro", "SemiBold", "SourceSerifPro-Semibold"],
    ["Source Serif Pro", "SemiBold Italic", "SourceSerifPro-SemiboldIt"],
    ["Source Serif Pro", "Bold", "SourceSerifPro-Bold"],
    ["Source Serif Pro", "Bold Italic", "SourceSerifPro-BoldIt"],
    ["Source Serif Pro", "Black", "SourceSerifPro-Black"],
    ["Source Serif Pro", "Black Italic", "SourceSerifPro-BlackIt"],
